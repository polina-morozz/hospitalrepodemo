        ...
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 60, alignItems: "start" }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 15, color: "#071e34", margin: "24px 0 12px" }}>When should you see a {singular.toLowerCase()} provider?</div>
              ...
              {[
                {
                  ...
                  title: "Quick facts",
                  items: ["Covered by most private health plans", "No referral needed in most cases", "Average session: 30–60 minutes", "First visit typically includes full assessment", "Most conditions improve within 4–8 sessions"],
                },
                {
                  ...
                  items: ["Acute and chronic pain", "Injury recovery and rehabilitation", "Preventive care and wellness", "Chronic disease management", "Post-surgical care", "Diagnostic evaluation"],
                },
                {
                  ...
                  title: "Average costs",
                  items: ["Initial visit: $100 – $300", "Follow-up sessions: $60 – $150", "Most plans cover $300–$1,500/year", "Many providers offer payment plans"],
                },
              ].map(card => (
